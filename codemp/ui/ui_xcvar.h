...
XCVAR_DEF( cg_autoswitch,                   "",                    NULL,                CVAR_NONE )
...
XCVAR_DEF( cjk_preciseFonts,                "1",                   NULL,                CVAR_ARCHIVE )
XCVAR_DEF( cl_downloadCount,                "",                    NULL,                CVAR_NONE )
XCVAR_DEF( cl_downloadSize,                 "",                    NULL,                CVAR_NONE )
XCVAR_DEF( cl_downloadTime,                 "",                    NULL,                CVAR_NONE )
XCVAR_DEF( cl_maxPing,                      "",                    NULL,                CVAR_NONE )
XCVAR_DEF( com_buildScript,                 "",                    NULL,                CVAR_NONE )
XCVAR_DEF( com_legacyprotocol,              "",                    NULL,                CVAR_NONE )
XCVAR_DEF( com_protocol,                    "",                    NULL,                CVAR_NONE )
XCVAR_DEF( developer,                       "",                    NULL,                CVAR_NONE )
XCVAR_DEF( debug_protocol,                  "",                    NULL,                CVAR_INTERNAL )
XCVAR_DEF( fs_copyfiles,                    "",                    NULL,                CVAR_NONE )
XCVAR_DEF( g_botsFile,                      "",                    NULL,                CVAR_INIT|CVAR_ROM )
XCVAR_DEF( g_doWarmup,                      "",                    NULL,                CVAR_NONE )
XCVAR_DEF( g_gametype,                      "",                    NULL,                CVAR_NONE )
XCVAR_DEF( g_maxForceRank,                  "",                    NULL,                CVAR_NONE )
XCVAR_DEF( g_spSkill,                       "3",                   NULL,                CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( g_warmup,                        "20",                  NULL,                CVAR_ARCHIVE )
XCVAR_DEF( handicap,                        "",                    NULL,                CVAR_NONE )
XCVAR_DEF( m_pitch,                         "",                    NULL,                CVAR_NONE )
XCVAR_DEF( m_pitchVeh,                      "",                    NULL,                CVAR_NONE )
XCVAR_DEF( name,                            "",                    NULL,                CVAR_NONE )
XCVAR_DEF( rate,                            "",                    NULL,                CVAR_NONE )
XCVAR_DEF( se_language,                     "english",             NULL,                CVAR_ARCHIVE|CVAR_NORESTART )
XCVAR_DEF( sv_maxClients,                   "",                    NULL,                CVAR_NONE )
XCVAR_DEF( sv_running,                      "",                    NULL,                CVAR_NONE )
...
XCVAR_DEF( ui_currentTier,                  "",                    NULL,                CVAR_INTERNAL )
XCVAR_DEF( ui_dedicated,                    "0",                   NULL,                CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_favoriteAddress,              "",                    NULL,                CVAR_INTERNAL )
XCVAR_DEF( ui_favoriteName,                 "",                    NULL,                CVAR_INTERNAL )
...
XCVAR_DEF( ui_findPlayer,                   "Player",              NULL,                CVAR_ARCHIVE|CVAR_INTERNAL )
...
XCVAR_DEF( ui_myteam,                       "",                    NULL,                CVAR_INTERNAL )
XCVAR_DEF( ui_Name,                         "",                    NULL,                CVAR_INTERNAL )
...
XCVAR_DEF( ui_r_modified,                   "",                    NULL,                CVAR_INTERNAL )
...
XCVAR_DEF( ui_rules_backout,                "",                    NULL,                CVAR_INTERNAL )
...
XCVAR_DEF( ui_teamName,                     "",                    NULL,                CVAR_NONE )
XCVAR_DEF( version,                         "",                    NULL,                CVAR_NONE )
#undef XCVAR_DEF
