...
// item types
#define ITEM_TYPE_SHADER       0  // simple shader
...
#define FEEDER_RESERVED_01           0x28 // differs in SP/MP
#define FEEDER_RESERVED_02           0x29 // differs in SP/MP
#define FEEDER_RESERVED_03           0x2a // differs in SP/MP
...
// cgame ownerdraw types
// ideally these should be done outside of this file but this makes it much easier for the macro expansion to convert
//	them for the designers (from the .menu files)
...
#define UI_JEDI_NONJEDI           289 // extra, for patch
