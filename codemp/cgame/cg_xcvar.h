...
XCVAR_DEF( bg_showEvents,                    "0",                      NULL,                 CVAR_NONE )
...
XCVAR_DEF( cg_drawAmmoWarning,               "1",                      NULL,                 CVAR_ARCHIVE )
...
XCVAR_DEF( cg_hudFiles,                      DEFAULT_HUDSET,		   NULL,                 CVAR_ARCHIVE )
XCVAR_DEF( cg_instantDuck,                   "1",                      NULL,                 CVAR_ARCHIVE )
...
XCVAR_DEF( cl_motdString,                    "",                       NULL,                 CVAR_NONE )
...
XCVAR_DEF( model,                            DEFAULT_MODEL "/default", NULL,                 CVAR_USERINFO|CVAR_ARCHIVE )
